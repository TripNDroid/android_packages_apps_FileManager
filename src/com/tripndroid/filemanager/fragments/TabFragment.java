...
import com.tripndroid.filemanager.ui.ColorCircleDrawable;
import com.tripndroid.filemanager.ui.drawer.EntryItem;
import com.tripndroid.filemanager.ui.views.DisablableViewPager;
import com.tripndroid.filemanager.ui.views.Indicator;
...
public class TabFragment extends android.support.v4.app.Fragment
    ...
    public void addTab(Tab tab, int pos, String path) {
        ...
        if (path != null && path.length() != 0)
            ...
            b.putString("lastpath", tab.getOriginalPath(true));
