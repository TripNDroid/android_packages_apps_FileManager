...
package com.tripndroid.filemanager.fragments;
...
import com.tripndroid.filemanager.adapters.RecyclerAdapter;
...
import com.tripndroid.filemanager.filesystem.MediaStoreHack;
import com.tripndroid.filemanager.services.asynctasks.LoadList;
import com.tripndroid.filemanager.ui.LayoutElement;
import com.tripndroid.filemanager.ui.dialogs.GeneralDialogCreation;
import com.tripndroid.filemanager.ui.icons.IconHolder;
import com.tripndroid.filemanager.ui.icons.Icons;
import com.tripndroid.filemanager.ui.icons.MimeTypes;
import com.tripndroid.filemanager.ui.views.DividerItemDecoration;
import com.tripndroid.filemanager.ui.views.FastScroller;
...
import com.tripndroid.filemanager.utils.files.FileListSorter;
...
public class MainFragment extends android.support.v4.app.Fragment {
    ...
    public boolean selection, results = false, GO_BACK_ITEM, SHOW_HIDDEN, SHOW_SIZE, SHOW_LAST_MODIFIED;
    ...
    public void onActivityCreated(final Bundle savedInstanceState) {
        ...
        dividerItemDecoration = new DividerItemDecoration(getActivity(), false, true);
        ...
        if (bitmap != null && isAdded()) {
            synchronized (bitmap) {
                ...
                if (addheader && IS_LIST) {
                    dividerItemDecoration = new DividerItemDecoration(getActivity(), true, true);
                    listView.addItemDecoration(dividerItemDecoration);
                    addheader = false;
                }
