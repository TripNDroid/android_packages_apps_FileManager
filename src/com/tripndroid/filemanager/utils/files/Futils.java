...
import com.tripndroid.filemanager.activities.DbViewer;
...
import com.tripndroid.filemanager.utils.share.ShareTask;
...
public class Futils {
    ...
    private boolean isSelfDefault(File f, Context c){
        ...
        return s.equals("com.tripndroid.filemanager") || rii == null;
    }
