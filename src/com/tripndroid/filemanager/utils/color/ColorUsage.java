...
public enum ColorUsage {
    ...
    PRIMARY_TWO("skin_two", R.color.primary_blue),
    ACCENT("accent_skin", R.color.primary_light_blue),
    ICON_SKIN("icon_skin", R.color.primary_cyan),
    CURRENT_TAB("current_tab", R.color.primary_light_blue);
