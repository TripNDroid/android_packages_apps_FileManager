...
package com.tripndroid.filemanager.utils.libsuperuser;
...
public abstract class HideOverlaysReceiver extends BroadcastReceiver {
    public static final String ACTION_HIDE_OVERLAYS = "com.tripndroid.filemanager.supersu.action.HIDE_OVERLAYS";
    public static final String CATEGORY_HIDE_OVERLAYS = Intent.CATEGORY_INFO;
    public static final String EXTRA_HIDE_OVERLAYS = "com.tripndroid.filemanager.supersu.extra.HIDE";
