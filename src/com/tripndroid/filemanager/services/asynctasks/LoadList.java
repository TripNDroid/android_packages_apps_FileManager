...
public class LoadList extends AsyncTask<String, String, ArrayList<LayoutElement>> {
    ...
    protected ArrayList<LayoutElement> doInBackground(String... params) {// params[0] is the url.
        ...
        switch (openmode) {
            ...
            case OTG:
                ...
                break;
            default:
                // we're not in OTG load the list based on root/general filesystem
                try {
     ...
     *
     * @param path the path to the directory tree, starts with prefix {@link com.tripndroid.filemanager.utils.OTGUtil#PREFIX_OTG}
